...
namespace Microsoft.AspNetCore.OData.Routing.Conventions
{
    ...
    public class AttributeRoutingConvention : IODataRoutingConvention
    {
        ...
        private IEnumerable<ODataPathTemplate> GetODataPathTemplates(RouteContext context, string prefix, ControllerActionDescriptor descriptor, IEdmModel model)
        {
        ...
        private IDictionary<ODataPathTemplate, ControllerActionDescriptor> BuildAttributeMappings(RouteContext context, IEnumerable<ControllerActionDescriptor> actionDescriptors, IEdmModel model)
        {
            ...
            foreach (ControllerActionDescriptor actionDescriptor in actionDescriptors)
            {
                ...
                {
                    IEnumerable<ODataPathTemplate> pathTemplates = GetODataPathTemplates(context, prefix, actionDescriptor, model);
