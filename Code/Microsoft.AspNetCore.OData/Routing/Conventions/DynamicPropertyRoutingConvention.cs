...
namespace Microsoft.AspNetCore.OData.Routing.Conventions
{
    ...
    public class DynamicPropertyRoutingConvention : NavigationSourceRoutingConvention
    {
        ...
        public override ActionDescriptor SelectAction(RouteContext routeContext, IEnumerable<ControllerActionDescriptor> actionDescriptors)
        {
            ...
            DynamicPathSegment dynamicPropertySegment = null;
            ...
            switch (odataPath.PathTemplate)
            {
                ...
                case "~/singleton/cast/dynamicproperty":
                    dynamicPropertySegment = odataPath.Segments.Last() as DynamicPathSegment;
                    if (dynamicPropertySegment == null)
                    {
                        return null;
                    }
            ...
            if (actionDescriptors != null && dynamicPropertySegment != null)
            {
                ...
                routeContext.RouteData.Values[ODataRouteConstants.DynamicProperty] = dynamicPropertySegment.Identifier;
                var key = ODataParameterValue.ParameterValuePrefix + ODataRouteConstants.DynamicProperty;
                var value = new ODataParameterValue(dynamicPropertySegment.Identifier, EdmLibHelpers.GetEdmPrimitiveTypeReferenceOrNull(typeof(string)));
