...
namespace Microsoft.AspNetCore.OData.Query
{
    ...
    public class SelectExpandQueryOption
    {
        ...
        public IQueryable ApplyTo(IQueryable queryable, ODataQuerySettings settings, IAssemblyProvider assembliesProvider)
        {
            ...
            //    .ToList();
            //if (!_request.ODataFeature().IsEnumerated)
            //{
            ...
            //{
            //    settings = new ODataQuerySettings(settings);
            //    settings.HandleNullPropagation = HandleNullPropagationOptionHelper.GetDefaultHandleNullPropagationOption(queryable);
            //}

            return SelectExpandBinder.Bind(queryable, settings, assembliesProvider, this, _serviceProvider);
        }
        ...
        public object ApplyTo(object entity, ODataQuerySettings settings, IAssemblyProvider assembliesProvider)
        {
            ...
            return SelectExpandBinder.Bind(entity, updatedSettings, assembliesProvider, this, _serviceProvider);
        }
