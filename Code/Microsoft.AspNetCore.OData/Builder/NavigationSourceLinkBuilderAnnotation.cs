...
namespace Microsoft.AspNetCore.OData.Builder
{
    ...
    public class NavigationSourceLinkBuilderAnnotation
    {
        ...
        /// </summary>
        public virtual Task<Uri> BuildNavigationLinkAsync(ResourceContext instanceContext, IEdmNavigationProperty navigationProperty, ODataMetadataLevel metadataLevel)
        {
            if (instanceContext == null)
            {
                throw Error.ArgumentNull("instanceContext");
            ...
            {
                return Task.FromResult(navigationLinkBuilder.Factory(instanceContext, navigationProperty));
            }
