...
//            {
//                throw new Exception("Error.ArgumentNull(\"serializerContext\")");
//            }
...
//            if (EdmObject == null)
//            {
//                throw new Exception("Error.InvalidOperation(SRResources.EdmObjectNull, typeof(EntityInstanceContext).Name)");
//            }
...
//                    throw new Exception("Error.InvalidOperation(SRResources.EdmTypeCannotBeNull, EdmObject.GetType().FullName, typeof(IEdmObject).Name)");
//                }

//                throw new Exception("Error.InvalidOperation(SRResources.PropertyNotFound, edmType.ToTraceString(), propertyName)");
//            }
//        }
...
//            if (entityType == null)
//            {
//                throw new Exception("Error.ArgumentNull(\"entityType\")");
//            }
