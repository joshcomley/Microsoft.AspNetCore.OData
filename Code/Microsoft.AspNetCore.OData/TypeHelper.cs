...
namespace Microsoft.AspNetCore.OData
{
    internal static class TypeHelper
    {
        ...
        /// <summary>
        /// Returns element type for the current request
        /// </summary>
        /// <returns></returns>
        internal static Type GetElementType(this ObjectResult result)
        {
            var singleResult = result.Value as SingleResult;
            var clrType = singleResult?.Queryable.GetType() ?? result.Value.GetType();
            var elementClrType = GetImplementedIEnumerableType(clrType) ?? clrType;
