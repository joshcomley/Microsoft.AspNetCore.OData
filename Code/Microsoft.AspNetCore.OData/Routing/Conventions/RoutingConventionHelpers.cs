    ...
    internal static class RoutingConventionHelpers
    {
        ...
        public static bool TryMatch(this KeySegment keySegment, IDictionary<string, string> mapping, IDictionary<string, object> values)
        {
            ...
            foreach (KeyValuePair<string, object> key in keySegment.Keys)
            {
                ...
                AddKeyValues(mappingName, mappingName, key.Value, typeReference, routeData, routeData);
            }
        ...
        private static void AddKeyValues(string key, string name, object value, IEdmTypeReference edmTypeReference, IDictionary<string, object> routeValues, IDictionary<string, object> odataValues)
        {
