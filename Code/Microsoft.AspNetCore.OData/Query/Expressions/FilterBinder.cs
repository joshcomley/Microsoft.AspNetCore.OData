...
namespace Microsoft.AspNetCore.OData.Query.Expressions
{
    ...
    public class FilterBinder : ExpressionBinderBase
    {
        ...
        public FilterBinder(IServiceProvider serviceProvider)
            : base(serviceProvider)
        {
        }

        internal static Expression Bind(FilterClause filterClause, Type filterType, IServiceProvider serviceProvider)
        {
            ...
            FilterBinder binder = serviceProvider.GetRequiredService<FilterBinder>();
