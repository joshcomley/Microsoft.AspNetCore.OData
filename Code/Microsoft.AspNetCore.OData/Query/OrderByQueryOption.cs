...
namespace Microsoft.AspNetCore.OData.Query
{
    ...
    public class OrderByQueryOption
    {
        ...
        internal OrderByQueryOption(OrderByQueryOption orderBy, IServiceProvider serviceProvider)
        {
            if (serviceProvider == null) throw new ArgumentNullException(nameof(serviceProvider));
            ...
            OrderByClause orderbyClause, IQueryable querySoFar, OrderByDirection direction, bool alreadyOrdered)
        {
            ...
            LambdaExpression orderByExpression =
                FilterBinder.Bind(orderbyClause, Context.ElementClrType, _serviceProvider);
